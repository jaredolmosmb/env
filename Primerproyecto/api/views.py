		 ...
		 for val in responseMA['entry']:
		 	if "Medication" == val['resource']['resourceType']:
		 		if 'code' in val['resource']:
		 			if 'coding' in val['resource']['code']:					
		 				for codM in val['resource']['code']['coding']:					
		 					if 'display' in codM:						
		 						if 'system' in codM:							
		 							if 'snomed' not in normalize(codM['system']):					
		 								data = normalize(codM['display'])
		 	...
		 	if "Procedure" == val['resource']['resourceType']:
		 		if 'code' in val['resource']:				
		 			if 'coding' in val['resource']['code']:					
		 				for codP in val['resource']['code']['coding']:					
		 					if 'display' in codP:						
		 						if 'system' in codP:							
		 							if 'snomed' not in normalize(codP['system']):					
		 					 			procedimiento = normalize(codP['display'])
		 	...
		 	if "Observation" == val['resource']['resourceType']:
		 		...
		 		if 'code' in val['resource']:
		 			if 'coding' in val['resource']['code']:
		 				for cod3 in val['resource']['code']['coding']:
		 					if 'display' in cod3:
		 						if 'system' in cod3:
		...
		if (recurso == 'Medication'):
			...
			if 'code' in responseMA:				
				if 'coding' in responseMA['code']:					
					for codM in responseMA['code']['coding']:					
						if 'display' in codM:						
							if 'system' in codM:							
								if 'snomed' not in normalize(codM['system']):					
									data = normalize(codM['display'])
